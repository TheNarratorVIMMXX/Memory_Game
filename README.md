...
A fully functional **Memory Card Game** with a soccer theme, developed with **Pygame**. This project demonstrates advanced game programming concepts including grid-based layouts, event handling, state management, and interactive gameplay mechanics.
